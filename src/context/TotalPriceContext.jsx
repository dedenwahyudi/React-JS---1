...
const TotalPriceContext = createContext(null); // context pertama untuk menyimpan statenya
const TotalPriceDispatchContext = createContext(null); // context yang kedua untuk menyimpan action-actionnya
